            ...
            <div class="job_listing_area">
                <div class="job_lists">
                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            {{-- If Str alias is available you can use Str::words(...) --}}
                                            ...
                                            <div class="d-grid mt-3">
                                                {{-- Prefer route helper; adjust route name & param as needed --}}
                        ...
                        @else
                            <div class="col-12">
                                <p>No jobs features available at this time.</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="job_listing_area">
                <div class="job_lists">
                    <div class="row">
                                    ...
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="bg-light p-3 border">
                                                ...
                                                @if(optional($latestJob->jobType)->name)
                                                    <p class="mb-0">
                                                        <span class="fw-bolder"><i class="fa fa-clock-o"></i></span>
                        ...
                        @else
                            <div class="col-12">
                                <p>No latest jobs available at this time.</p>
                            </div>
                        @endif
                    </div>
                </div>
