                ...
                <div class="card border-0 shadow mb-4">
                    <form action="" method="post" id="userform" name="userform">
                       ...
                       <p></p>
                        ...
                        {{-- Trumbowyg.com  used to make to show bold header like etc --}}
...
$("#userform").submit(function(e) {
    ...
    $.ajax({
        ...
        type: 'PUT',
        dataType: 'json',
        data: $("#userform").serializeArray(), // ✅ fixed typo here
...
$("#changePasswordForm").submit(function(e) {
    ...
    $.ajax({
        ...
        type: 'post',
        dataType: 'json',
        data: $("#changePasswordForm").serializeArray(), // ✅ fixed typo here
        success: function(response) {
