                    ...
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            <div class="mb-4 col-md-6">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="isFeaturedt">
                                        Featured
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 col-md-6">
                                <div class="form-check-inline">
                                    <input {{ ($job->status == 1) ? 'checked' : '' }}class="form-check-input" type="radio" value="1" id="status" name="status">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="textarea" name="description"
                             id="description" cols="5" rows="5" placeholder="Description">{{ $job->description }}</textarea>
                          <p></p>
                        </div>
                        
                        <div class="mb-4">
                            <label for="" class="mb-2">Benefits</label>
                            <textarea class="textarea" name="benefits"
                             id="benefits" cols="5" rows="5" placeholder="Benefits">{{ $job->benefits }}</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Responsibility</label>
                            <textarea class="textarea" name="responsibility"
                             id="responsibility" cols="5" rows="5" placeholder="Responsibility">{{ $job->responsibility }}</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Qualifications</label>
                            <textarea class="textarea" name="qualifications" 
...
$("#editJobForm").submit(function(e) {
    ...
    $.ajax({
        ...
        type: 'PUT',
        dataType: 'json',
        data: $("#editJobForm").serializeArray(), // ✅ fixed typo here
    ...
    function deleteUser(id) {
        if (confirm("Are you sure you want to delete?")) {
            $.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    window.location.href = "{{ route('admin.users.destroy') }}"
                }
            });
        }
    }
